...
// This lock is used to set Lock for processes using TAS
atomic_flag atm_lock = ATOMIC_FLAG_INIT;
...
int main()
{
  ...
  out = fopen("TAS_output.txt", "w");
  fprintf(out, "TAS ME Output:\n");
