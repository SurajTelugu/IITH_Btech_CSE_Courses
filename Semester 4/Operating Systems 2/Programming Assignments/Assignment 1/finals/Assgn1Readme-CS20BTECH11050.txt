...
For Linux Operating Systems:
 ...
 1) Go to the folder containing the code file and run the following commands in Linux terminal
      command1: $gcc Assign1Src-CS20BTECH11050.c -lm -lpthread
      command2:$./a.out
    
    To name the output file run the following commands
      command1: $gcc -o <name of output> Assign1Src-CS20BTECH11050.c -lm -lpthread
 ...
 Input in file named "input.txt" is in the following format:
   1)Number of threads 
   2)Source point in the format (x,y)
   3)Number of points
   4)Above number of points in the format (x,y)
