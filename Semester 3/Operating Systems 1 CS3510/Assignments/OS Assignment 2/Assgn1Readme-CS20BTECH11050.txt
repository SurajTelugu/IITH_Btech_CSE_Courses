...
1) Go to the folder containing the code file and run the following commands in Linux terminal
      command1: $gcc Assign1Src-CS20BTECH11050.c
      command2:$./a.out
    
   To name the output file run the following commands
      command1: $gcc -o <name of output> Assign1Src-CS20BTECH11050.c
...
2) Enter the desired integer to get its collatz sequence. 
   If negative integers are entered program terminates
 ...
 2) You can also use the following online IDEs which uses Ubuntu(Linux)
      ...
      https://replit.com/~
    You can paste the source code in any of the above online IDEs 
    and run directly or you can also use the above commands 